...
public enum WeaponType {
    knife(new Texture(Gdx.files.internal("UI/GameUI/Weapon/gradient.png")), new Texture(Gdx.files.internal("UI/GameUI/Weapon/redGradient.png")), new Texture(Gdx.files.internal("UI/GameUI/Weapon/effKnifeAttack.png")), 80, 120, 3, 2, 200);
